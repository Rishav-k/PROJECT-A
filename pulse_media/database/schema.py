...
def init_db(reset: bool = False):
    ...
    sources_seed = [
        ...
        ("yahoo_finance",   "Yahoo Finance",     "rss",     "finpulse",  "https://feeds.finance.yahoo.com/rss/2.0/headline"),
        ...
        ("reuters_biz",     "Reuters Business",  "rss",     "finpulse",  "https://feeds.reuters.com/reuters/businessNews"),
        ...
        ("bls_gov",         "BLS (Inflation)",   "rss",     "finpulse",  "https://www.bls.gov/feed/bls_latest.rss"),
        ...
        ("reuters_world",   "Reuters World",     "rss",     "worldpulse","https://feeds.reuters.com/reuters/worldNews"),
        ...
        ("ap_news",         "AP News",           "rss",     "worldpulse","https://apnews.com/apf-worldnews?format=rss"),
        ("reuters_corp",    "Reuters Corp",      "rss",     "corppulse", "https://feeds.reuters.com/reuters/businessNews"),
        ("forbes",          "Forbes",            "rss",     "corppulse", "https://www.forbes.com/real-time/feed2/"),
        ("ft_corp",         "Financial Times",   "rss",     "corppulse", "https://www.ft.com/?format=rss"),
        # ── Google News (8 sources, 2 per page) ──────────────────────────────
        ("google_news_finance",    "Google News Finance",    "rss", "finpulse",  "https://news.google.com/rss/topics/CAAqJggKIiBDQkFTRWdvSUwyMHZNRGx6TVdZU0FtVnVHZ0pWVXlnQVAB?hl=en-US&gl=US&ceid=US:en"),
        ("google_news_stocks",     "Google News Stocks",     "rss", "finpulse",  "https://news.google.com/rss/search?q=stock+market+nasdaq+SP500+investing+fed+rate&hl=en-US&gl=US&ceid=US:en"),
        ("google_news_tech",       "Google News Tech",       "rss", "techpulse", "https://news.google.com/rss/topics/CAAqJggKIiBDQkFTRWdvSUwyMHZNREptZEhjU0FtVnVHZ0pWVXlnQVAB?hl=en-US&gl=US&ceid=US:en"),
        ("google_news_ai",         "Google News AI",         "rss", "techpulse", "https://news.google.com/rss/search?q=artificial+intelligence+OpenAI+LLM+startup+funding+tech&hl=en-US&gl=US&ceid=US:en"),
        ("google_news_corp",       "Google News Business",   "rss", "corppulse", "https://news.google.com/rss/topics/CAAqJggKIiBDQkFTRWdvSUwyMHZNRGx6TVdZU0FtVnVHZ0pWVXlnQVAB?hl=en-US&gl=US&ceid=US:en"),
        ("google_news_earnings",   "Google News Earnings",   "rss", "corppulse", "https://news.google.com/rss/search?q=CEO+earnings+merger+acquisition+corporate+layoffs+IPO&hl=en-US&gl=US&ceid=US:en"),
        ("google_news_world",      "Google News World",      "rss", "worldpulse","https://news.google.com/rss/topics/CAAqJggKIiBDQkFTRWdvSUwyMHZNRGx1YlY4U0FtVnVHZ0pWVXlnQVAB?hl=en-US&gl=US&ceid=US:en"),
        ("google_news_geopolitics","Google News Geopolitics","rss", "worldpulse","https://news.google.com/rss/search?q=election+conflict+diplomacy+geopolitics+sanctions+war+ceasefire&hl=en-US&gl=US&ceid=US:en"),
    ]
